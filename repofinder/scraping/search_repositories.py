...
import logging
import os
from repofinder.scraping.repo_scraping_utils import search_repositories_with_queries, build_repo_queries

logger = logging.getLogger(__name__)
logger.setLevel(logging.DEBUG)


def search_repositories(config, headers):
    """
    ...
    query_terms, university_acronym = build_repo_queries(config)
